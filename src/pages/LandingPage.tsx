        ...
        <section id="ia" className="relative overflow-hidden">
          <div className="mx-auto grid max-w-7xl gap-12 px-4 py-14 sm:px-6 sm:py-20 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:py-24">
            ...
            <Card className="overflow-hidden border-emerald-500/20 bg-[linear-gradient(180deg,rgba(5,18,11,0.96),rgba(2,2,2,0.98))] p-5 shadow-[0_0_80px_rgba(16,185,129,0.12)] sm:p-6">
              <div className="flex items-center justify-between border-b border-white/10 pb-4"><div><div className="text-xs uppercase tracking-[0.2em] text-zinc-500">Gluck&apos;s Trader IA</div><div className="mt-1 text-xl font-bold">WIN • Análise consolidada</div></div><div className="rounded-full border border-emerald-500/20 bg-emerald-500/10 px-3 py-1 text-xs text-emerald-300">IA</div></div>
              <div className="mt-5 flex items-start justify-between gap-4"><div><div className="text-xs uppercase tracking-wide text-zinc-500">Direção</div><div className="mt-1 text-3xl font-black text-emerald-400">COMPRA</div></div><div className="text-right"><div className="text-xs uppercase tracking-wide text-zinc-500">Confiança</div><div className="mt-1 text-3xl font-black">85%</div></div></div>
              <div className="mt-5 grid grid-cols-2 gap-3"><div className="rounded-2xl border border-white/10 bg-black/30 p-4"><div className="text-xs text-zinc-500">Entrada</div><div className="mt-2 text-xl font-bold">129.450</div></div><div className="rounded-2xl border border-red-500/20 bg-red-500/5 p-4"><div className="text-xs text-zinc-500">Stop</div><div className="mt-2 text-xl font-bold text-red-400">128.980</div></div><div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-4"><div className="text-xs text-zinc-500">Alvo</div><div className="mt-2 text-xl font-bold text-emerald-400">130.320</div></div><div className="rounded-2xl border border-cyan-500/20 bg-cyan-500/5 p-4"><div className="text-xs text-zinc-500">Risco/Retorno</div><div className="mt-2 text-xl font-bold text-cyan-300">1 : 1,85</div></div></div>
              <div className="mt-5 rounded-2xl border border-white/10 bg-black/30 p-4"><div className="flex items-center justify-between text-sm"><span className="text-zinc-400">Confluência do cenário</span><span className="font-semibold text-emerald-300">Alta</span></div><div className="mt-3 h-2 overflow-hidden rounded-full bg-zinc-800"><div className="h-full w-[85%] rounded-full bg-emerald-400" /></div></div>
              <p className="mt-4 text-xs leading-5 text-zinc-500">Exemplo visual ilustrativo. Não representa garantia de resultado.</p>
            </Card>
          </div>
        </section>
